...
public class IntegrantesService {
    ...
    public ResponseEntity<IntegrantesResponse> integrantes_familia(int cod_familiar, IntegrantesModel integrantes, BindingResult result) {
        ...
        IntegrantesModel example = new IntegrantesModel(integrantes.getDni());
    ...
    public HomeResponse getAllIntegrantesByCodigo(int codigo_familiar) {
        FamiliasModel familias = familiasRepository.findByCodigofamiliar(codigo_familiar);
        HomeResponse response = new HomeResponse();
        response.setNombrefamilia(familias.getNombrefamilia());
        response.setCodigofamiliar(familias.getCodigofamiliar());
        List<IntegrantesModel> allIntegrantes = integrantesRepository.findIntegrantesByFamilias_Codigofamiliar(codigo_familiar);
